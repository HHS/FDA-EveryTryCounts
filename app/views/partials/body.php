<main>
    <div 
            ...
            <div class="col-lg-7 col-lg-offset-1 col-md-7 col-sm-12">
                <div class="programs">
                    ...
                    <p 
                        id="choose-one-text" 
                        class="choose-one">
                        Choose <span class="circle">1</span> of our text message programs to help you quit
                    </p>
                                ...
                                <div 
                                    ...
                                    <span class="input-group-btn">
                                        <button 
                                            ...
                                            type="button" 
                                            onclick="makeFloodlightTagCall('DC-4345482/CTP/posev000+standard')" 
                                ...
                                <div 
                                    ...
                                    <span class="input-group-btn">
                                        <button 
                                            ...
                                            class="btn btn-signup" 
                                            type="button" 
                                            onclick="makeFloodlightTagCall('DC-4345482/CTP/posev002+standard')" 
                                ...
                                <div 
                                    ...
                                    <span class="input-group-btn">
                                            <button 
                                                ...
                                                class="btn btn-signup" 
                                                type="button" 
                                                onclick="makeFloodlightTagCall('DC-4345482/CTP/posev004+standard')" 
                    ...
                    <button 
                        ...
                        <span class="btn-emphasis">I WANT TO TRY A SMALL STEP</span><br>Help me build skills to try quitting
                    </button>
                    <button 
                        class="btn try-something-new-btn" 
                        ...
                        <span class="btn-emphasis">
                            I Want to Practice Quitting
                        </span>
                        <br>Try it for a few days
                    </button>
                    <button 
                        class="btn try-something-new-btn" 
            ...
            <div class="col-lg-8 col-lg-offset-1 col-md-7 col-md-offset-1 col-sm-12">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe 
                        ...
                        src="https://www.youtube.com/embed/MBdUZYuoEiw?rel=0">
                    </iframe>
                </div>
            </div>
        </div>
        <div class="row tips element-visible" data-gtm="Deal with Cravings">
            ...
            <div 
                class="col-lg-6 col-lg-offset-1 col-md-6 col-sm-12">
                        ...
                        <div 
                            ...
                            <div class="front">
                                ...
                                <button 
                                    ...
                                    onclick="makeFloodlightTagCall('DC-4345482/CTP/posev005+standard')" 
